...
interface SelectableSortableItemProps {
  isSelected: boolean;
  onSelect: (id: string, isCtrlSelected: boolean) => void;
  isDropped?: boolean;
  containerId: string;
  id: string;
  index: number;
...
export function Selectable({
  ...
  const onSelectionChanged = (id: string, isCtrlSelected: boolean) => {
    console.log("onSelectionChanged", id, isCtrlSelected);
    if (isCtrlSelected) {
      console.log("1");
